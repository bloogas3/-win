...
Дерево правой части, которая вычисляет значение a:
...
Левый минус меняет знак x. Правый минус вычитает 1 из z. Результат вычитания умножается на y, затем складывается с -x.

Скобки отдельными узлами не рисуются, порядок действий уже показан ветвями дерева.
